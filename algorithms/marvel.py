...
from algorithms.orient import meek
...
def find_mb_filtered(data: pd.DataFrame, ci_test: Callable) -> np.ndarray:
    """
...
def marvel(
    ...
    **kwargs,
    ...
    # Learn skeleton
    mb_fun = lambda data: find_mb_filtered(data, rcd_test)
    ...
    # Convert to causal-learn format
    pdag = -pdag.copy()
    pdag[(pdag == 0) & (pdag.T == -1)] = 1
    # Orient Meek rules
    cpdag = meek(pdag)
